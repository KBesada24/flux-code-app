...
const ProjectionLatestTurnDbRowSchema = Schema.Struct({
  ...
  sourceProposedPlanThreadId: Schema.NullOr(ProjectionThread.fields.threadId),
  sourceProposedPlanId: Schema.NullOr(ProjectionThreadProposedPlan.fields.planId),
});
